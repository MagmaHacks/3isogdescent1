...
Since recently, I am also planning to look at the general ```3selmer.m``` Magma code for a full 3-descent. It seems that a lot of black-box is-it-a-perfect-cube guessing might still be happening there (e.g., the "algebra B" step is very slow at times).
